...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('payments.update', Hashids::encode($payment->id)) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control"
                                ...
                                name="description"
                                rows="3"
                                placeholder="Enter description for this withdrawal">{{ old('description', $payment->description) }}</textarea>
                            @error('description')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6 text-end">
                            <button type="submit" class="btn btn-primary">
                                <i class="bx bx-save me-1"></i> Update Withdrawal
                            </button>
                        </div>
                    </div>
                </form>
