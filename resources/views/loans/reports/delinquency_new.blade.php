            ...
            <div class="col-md-2">
                <div class="card bg-success text-white">
                    <div class="card-body text-center">
                        ...
                        <small class="text-muted">TZS {{ number_format($delinquencyData['buckets']['1-30']['amount'], 0) }}</small>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="card bg-warning text-white">
                    <div class="card-body text-center">
                        ...
                        <small class="text-muted">TZS {{ number_format($delinquencyData['buckets']['31-60']['amount'], 0) }}</small>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="card bg-orange text-white">
                    <div class="card-body text-center">
                        ...
                        <small class="text-muted">TZS {{ number_format($delinquencyData['buckets']['61-90']['amount'], 0) }}</small>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="card bg-danger text-white">
                    <div class="card-body text-center">
                        ...
                        <small class="text-muted">TZS {{ number_format($delinquencyData['buckets']['91-180']['amount'], 0) }}</small>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="card bg-dark text-white">
                    <div class="card-body text-center">
                        ...
                        <small class="text-muted">TZS {{ number_format($delinquencyData['buckets']['180+']['amount'], 0) }}</small>
                    </div>
                </div>
            </div>
        </div>
