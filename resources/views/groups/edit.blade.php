                ...
                <div class="card radius-10">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h4 class="card-title mb-0">Edit Group: {{ $group->name }}</h4>
                        </div>
                        ...
                        <form action="{{ route('groups.update', Hashids::encode($group->id)) }}" onsubmit="return handleSubmit(this)" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="loan_officer" class="form-select select2-single @error('loan_officer') is-invalid @enderror" >
                                        ...
                                        <option value="{{ $officer->id }}"
                                            {{ old('loan_officer', $group->loan_officer) == $officer->id ? 'selected' : '' }}>
                                ...
                                <!-- Minimum Members -->
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Minimum Members <span class="text-gray">(Optional)</span></label>
                                    <input type="number" name="minimum_members" class="form-control @error('minimum_members') is-invalid @enderror"
                                        value="{{ old('minimum_members', $group->minimum_members) }}" min="1" max="50" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="time" name="meeting_time" class="form-control @error('meeting_time') is-invalid @enderror"
                                        value="{{ old('meeting_time', $group->meeting_time ? $group->meeting_time->format('H:i') : '') }}">
                                    @error('meeting_time')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-end gap-2">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="bx bx-save"></i> Update Group
                                        </button>
                                    </div>
                                </div>
                            </div>
