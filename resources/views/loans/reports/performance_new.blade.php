            ...
            <div class="col-md-3">
                <div class="card bg-success text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h3 class="mb-0">{{ number_format($performanceData['summary']['excellent_loans']) }}</h3>
            ...
            <div class="col-md-3">
                <div class="card bg-info text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h3 class="mb-0">{{ number_format($performanceData['summary']['good_loans']) }}</h3>
            ...
            <div class="col-md-3">
                <div class="card bg-warning text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h3 class="mb-0">{{ number_format($performanceData['summary']['fair_loans']) }}</h3>
            ...
            <div class="col-md-3">
                <div class="card bg-danger text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h3 class="mb-0">{{ number_format($performanceData['summary']['poor_loans']) }}</h3>
            ...
            <div class="col-md-3">
                <div class="card bg-primary text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h3 class="mb-0">{{ number_format($performanceData['summary']['average_repayment_rate'], 2) }}%</h3>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge 
                                        ...
                                        @elseif($loan['performance_grade'] == 'Poor') bg-orange
                                        @else bg-danger
                                        @endif">
